...
class Giasu extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['hoten', 'email', 'sdt', 'matkhau','fanh', 'fanhcmnd'], 'required'],
            [['gioitinh', 'trangthai'], 'integer'],
            [['hoten', 'ngaysinh', 'cmnd', 'anh', 'anhcmnd', 'email', 'sdt', 'matkhau', 'svtruong', 'gvtruong', 'nganhhoc', 'diachi', 'luongyeucau'], 'string', 'max' => 255],
            [['fanh', 'fanhcmnd'], 'file']
        ];
    }
