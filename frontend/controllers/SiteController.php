...
class SiteController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            // echo "ai dang login: " .$model->loginOwner(); exit;
            if ($model->loginOwner()){ //neu la chu xe cho vo trang khac
                // echo "OWNER is Logged"; exit;
                //return $this->goHome();
                // $this->layout = 'layoutowner';
